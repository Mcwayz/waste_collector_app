...
public class CollectionsActivity extends AppCompatActivity implements RecyclerViewInterface {
    ...
    private void getProfile(){
        ...
        detailsResponseCall.enqueue(new Callback<DetailsResponse>() {
            ...
            public void onResponse(Call<DetailsResponse> call, Response<DetailsResponse> response) {
                if(response.isSuccessful()){
                    ...
                    if (detailsResponse != null) {
                        ...
                        Toast.makeText(CollectionsActivity.this, "Work Area: "+work+" Vehicle :"+work_vehicle, Toast.LENGTH_SHORT).show();
                    }else{
                        ...
                        builder.setPositiveButton("Okay", (dialog, which) -> {
                            dialog.dismiss();
                            Intent intent = new Intent(CollectionsActivity.this, ProfileActivity.class);
            ...
            public void onFailure(Call<DetailsResponse> call, Throwable t) {
                Toast.makeText(CollectionsActivity.this, "Error Returning User Profile" +t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                dialog.dismiss();
                goBack();
            }
        });
    ...
    private void getRequests() {
        ...
        try {
            ...
            Toast.makeText(CollectionsActivity.this, "Collector ID: " + prof_id, Toast.LENGTH_SHORT).show();
            ...
            call.enqueue(new Callback<List<Collection>>() {
                ...
                public void onResponse(Call<List<Collection>> call, Response<List<Collection>> response) {
                    if(response.isSuccessful()){
                        ...
                        runOnUiThread(() -> {
                            ...
                            customAdapter = new CustomAdapter(CollectionsActivity.this, task_id, collection_id, address, desired_date, assigned_date, is_collected, CollectionsActivity.this);
                            recyclerView.setAdapter(customAdapter);
                            Toast.makeText(CollectionsActivity.this, "Your Complete Tasks!", Toast.LENGTH_SHORT).show();
                        });
                    }
                }
                ...
                public void onFailure(Call<List<Collection>> call, Throwable t) {
                    Toast.makeText(CollectionsActivity.this, "Error Fetching Data: " + t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                    Log.d("Collection Data", "Error Msg: " + t.getLocalizedMessage());
                }
            });
        } catch (NumberFormatException e) {
            Toast.makeText(CollectionsActivity.this, "Invalid collector ID", Toast.LENGTH_SHORT).show();
    ...
    public void onItemClick(int position) {
        ...
        builder.setPositiveButton("View Location", (dialog, which) -> {
            dialog.dismiss();
            Intent intent = new Intent(CollectionsActivity.this, LocationActivity.class);
